  ...
  return (
    ...
    <div className="header-wrap mw">
      ...
      <div className="hamburger" id="hamburger" onClick={handleOnClick}>
        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" fill="#000" viewBox="0 0 19 18">
          <rect width="19" height="4" y="7" rx="2" />
          <path d="M5 0h9a2 2 0 0 1 2 2v2H3V2a2 2 0 0 1 2-2zm9 18H5a2 2 0 0 1-2-2v-2h13v2a2 2 0 0 1-2 2z" />
        </svg>
      </div>
    </div>
  </header>
    ...
    //   <div classNameName='header__container container'>
    //     <div classNameName='header__logo-wrap'>
    //       <a href='/' classNameName='header__logo-link'>
    //         <img src={logo} alt='site logo' classNameName='header__logo' />
    //       </a>
    //     </div>
    //     <nav classNameName='header__nav nav'>
    //       <ul classNameName='nav__container'>
    //         <li classNameName='nav__element'>
    //           <a href='/' classNameName='nav__link'>
    //             Features
    //           </a>
    //         </li>
    //         <li classNameName='nav__element'>
    ...
    //         </li>
    //       </ul>
    //       <div classNameName='nav__btns-wrap'>
    //         <button classNameName='nav__btn'>Login</button>
    //         <button classNameName='nav__btn nav__btn--marked'>Sign Up</button>
    //       </div>
    //     </nav>
    //     <div onClick={handleHambugerOnClick} classNameName='header__hamburger-menu'>
    //       <span classNameName='header__hamburger-menu-icon fas fa-bars'></span>
    //     </div>
    //   </div>
    // </header>
  );
